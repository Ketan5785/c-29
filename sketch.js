...
function setup() {
  ...
  //first level
  BlockBlue1 = new Box(240, 2, 20, 20);

  BlockBlue2 = new Box(320, 2, 20, 20);
  ...
  //second level
  BlockPink1 = new BoxPink(260, 2, 20, 20);

  BlockPink2 = new BoxPink(220, 2, 20, 20);

  BlockPink3 = new BoxPink(240, 40, 20, 20);

  BlockPink4 = new BoxPink(240, 60, 20, 20);

  BlockPink5 = new BoxPink(280, 80, 20, 20);

  BlockPink6 = new BoxPink(300, 0, 20, 20);
  ...
  polygon_1 = new poly(40, 100, 20, 20);
